...
namespace Midterm.Controllers
{
    public class CourseModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CourseCode,CourseName,CourseDescription,CourseCost")] CourseModel courseModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,CourseCode,CourseName,CourseDescription,CourseCost")] CourseModel courseModel)
        {
            if (ModelState.IsValid)
            {
